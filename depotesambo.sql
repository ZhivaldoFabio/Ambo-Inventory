...
CREATE TABLE IF NOT EXISTS `detailpembelian` (
  ...
  CONSTRAINT `FK_detailpembelian_suppliers` FOREIGN KEY (`id_supplier`) REFERENCES `suppliers` (`id_supplier`) ON UPDATE CASCADE,
  CONSTRAINT `FK_detailpembelian_units` FOREIGN KEY (`id_unit`) REFERENCES `units` (`id_unit`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table depotesambo.detailpembelian: ~0 rows (approximately)
DELETE FROM `detailpembelian`;
INSERT INTO `detailpembelian` (`id_detail_pembelian`, `id_pembelian`, `id_unit`, `id_produk`, `id_supplier`, `jumlah_produk`, `harga`, `total_harga_pembelian`) VALUES
	(1, 1, 1, 1, 3, 5, 14000, 70000),
	(2, 2, 1, 7, 8, 12, 17000, 204000);
...
INSERT INTO `pembelian` (`id_pembelian`, `tanggal_pembelian`, `total_harga`) VALUES
	(1, '2024-11-06 16:56:14', 10000),
	(2, '2024-11-06 16:56:14', 10000),
	(3, '2024-11-18 15:46:53', 20000);
